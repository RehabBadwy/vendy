  ...
  Widget build(context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius:
        /*isPhoneNumber ?*/
        const BorderRadius.only(topRight: Radius.circular(20), bottomRight: Radius.circular(20),bottomLeft:Radius.circular(20),topLeft: Radius.circular(20) ),
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          isDense: true,
          counterText: '',
          focusedBorder: OutlineInputBorder(borderSide: BorderSide(color:Color(0xffE8ECF4))),
          hintStyle: TextStyle(
